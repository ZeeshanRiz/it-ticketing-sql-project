...
- SQL Schema Design
- Data cleaning and cleansing (turning raw data into usable columns)
- As well as writing data analytical queries for IT operations

Technology Stack:
- SQLite (local file database: 'it_tickets.db)
- SQL (DDL & DML)
- VS Code with the SQLite extension

What I have learned:
Designed an SQL Schema from a flat CSV IT help desk dataset
Cleaned and transformed it into usable analytics
Wrote Queries:
